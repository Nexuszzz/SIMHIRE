...
// Mock Candidate Profiles (Sanitized)
export const MOCK_CANDIDATE_PROFILES: CandidateProfile[] = [
  {
    id: 'cand-1',
    name: 'Budi Santoso',
    email: 'budi@email.com', // visible after interview stage
  ...
  },
  {
    id: 'cand-4',
    name: 'Lisa Permata',
    email: 'lisa@email.com', // visible after interview stage
