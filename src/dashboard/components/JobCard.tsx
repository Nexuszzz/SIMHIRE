...
interface JobCardProps {
  promo?: boolean;
  job?: Job; // optional agar kompatibel dengan pemakaian lama (hardcoded)
}
...
const JobCard: React.FC<JobCardProps> = ({ promo, job }) => {
  ...
  // Fallback data jika job tidak disediakan
