...
const DashboardOverview = () => {
  ...
  useEffect(() => {
    ...
    setUpcomingInterviews(interviews.slice(0, 3)); // Top 3
  ...
  // Calculate real application activity from data
  ...
  // Show empty state or actual applications
        ...
        <div className="bg-white rounded-card p-6 border border-gray-200">
          ...
          {hasData ? (
            <div className="space-y-4">
              ...
              {/* Empty state when has data but no recent activity */}
