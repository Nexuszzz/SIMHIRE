...
const Profile: React.FC = () => {
  ...
  useEffect(()=>{
    try { setTopProjects(getTopProjects()); } catch { /* ignore */ }
  }, [isEditing]);
  ...
  // Load simulasi results for stats
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto py-8 px-6 space-y-8">
      ...
      >
        {/* Background Pattern */}
        <div className="absolute inset-0 bg-gradient-to-r from-primary-500 via-blue-500 to-purple-500 opacity-10 rounded-2xl"></div>
        
        <div className="relative bg-white/80 backdrop-blur-xl rounded-2xl border-2 border-primary-200 p-8 shadow-2xl">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
            {/* Avatar with Gradient Ring */}
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-primary-400 to-purple-500 rounded-2xl blur-xl opacity-50"></div>
              <motion.div 
                whileHover={{ scale: 1.05 }}
                className={`relative w-32 h-32 rounded-2xl ${user.avatarColor||'bg-gradient-to-br from-primary-500 to-blue-600'} flex items-center justify-center text-white text-5xl font-bold shadow-2xl border-4 border-white`}
              >
                {user.name.charAt(0)}
              </motion.div>
            </div>
            ...
            <div className="flex-1 space-y-4">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="px-3 py-1 bg-gradient-to-r from-green-400 to-emerald-500 text-white text-xs font-bold rounded-full flex items-center gap-1">
              ...
              <div className="flex flex-wrap gap-3">
                <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-100 to-cyan-100 rounded-xl">
                ...
                {avgSimulasiScore > 0 && (
                  <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-yellow-100 to-orange-100 rounded-xl">
