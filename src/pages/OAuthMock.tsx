...
const GoogleLogo = () => (
  <svg width="22" height="22" viewBox="0 0 256 262" xmlns="http://www.w3.org/2000/svg" aria-hidden>
...
const LinkedInLogo = () => (
  <svg width="22" height="22" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" aria-hidden>
...
const OAuthMock: React.FC = () => {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    if (!email) return;
    setLoading(true);
    // Simulasi redirect ke callback seperti OAuth asli
    setTimeout(() => {
