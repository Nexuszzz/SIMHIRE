    ...
    <section id="home" className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-primary-900/30 text-white min-h-screen flex items-center overflow-hidden pt-20 sm:pt-24 md:pt-28 lg:pt-36 scroll-mt-20 sm:scroll-mt-24 md:scroll-mt-28 lg:scroll-mt-36">
      ...
      <div className="max-w-7xl mx-auto mobile-container">
        <div className={`text-center mb-12 sm:mb-16 transition-all duration-1000 ${
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight mb-4 sm:mb-6 leading-[1.15] sm:leading-[1.1] max-w-5xl mx-auto px-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-6 md:gap-8">
              {[
                ...
                <div key={index} className={`text-center group transition-all duration-500 delay-${stat.delay}`}>
                  <div className={`w-16 h-16 sm:w-20 sm:h-20 bg-${stat.color}-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl`}>
                    <span className={`text-xl sm:text-2xl font-bold text-${stat.color}-600 group-hover:scale-110 transition-transform duration-300`}>
                      {stat.number}
                    </span>
                  </div>
